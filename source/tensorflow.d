...
extern char* TF_Message(const(TF_Status*) s);
...
extern TF_Tensor* TF_NewTensor(TF_DataType, long* dims, int num_dims,
                               void* data, size_t len,
                               void function(void* data, size_t len,
                                                   void* arg) deallocator,
...
extern long TF_Dim(const(TF_Tensor*) tensor, int dim_index);

// Return the size of the underlying data in bytes.
extern ulong TF_TensorByteSize(const(TF_Tensor*));
...
extern struct TF_SessionOptions;
...
extern void TF_SetConfig(TF_SessionOptions* options, const(char*) config,
                         ulong config_len, TF_Status* status);
...
extern void TF_ExtendGraph(TF_Session*, const(void*) proto, ulong proto_len,
                           TF_Status*);
